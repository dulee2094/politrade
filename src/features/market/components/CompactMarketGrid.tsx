        ...
        {politicians.map((pol) => {
          ...
          return (
            <div
              ...
              className="bg-slate-950/70 hover:bg-slate-850 p-3 rounded-2xl border border-slate-800 hover:border-cyan-400/60 transition-all duration-200 cursor-pointer space-y-2 group shadow-sm hover:-translate-y-0.5"
            >
