...
export const WeeklyPulseReportCard: React.FC<WeeklyPulseReportCardProps> = ({ onOpenDetail, onOpenReviewsDetail }) => {
  ...
  return (
    <div className="relative overflow-hidden bg-slate-900 p-5 rounded-3xl border border-amber-500/30 shadow-2xl h-full flex flex-col justify-between space-y-4">
      ...
      {/* ================================================================ */}
      {/* 1. 지난 주 베스트/워스트 3인 선정결과 [PAST - CLOSED] */}
      {/* ================================================================ */}
      <div className="bg-slate-950/70 p-4 rounded-2xl border border-indigo-500/30 space-y-3">
        ...
        <div className="text-[10px] text-slate-400 flex items-center justify-between pt-0.5 font-sans">
          <span>💡 1~3위 전체 목록 및 배당금 수령은 우측 <strong className="text-indigo-300">[상세현황 (배당 정산)]</strong> 버튼에서 확인하실 수 있습니다.</span>
        </div>
      </div>

      {/* ================================================================ */}
      {/* 2. 지난 주 베스트 한 줄평 선정결과 [PAST - CLOSED] */}
      {/* ================================================================ */}
      ...
      {/* ================================================================ */}
      {/* 3. 금주 베스트/워스트 투표 현황 (월~어제 누적) [LIVE] */}
      {/* ================================================================ */}
      ...
      <div className="bg-slate-950/70 p-4 rounded-2xl border border-slate-800 space-y-3">
        ...
        {(() => {
          ...
          return (
            <div className="bg-slate-900 p-3 rounded-xl border border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-sm">
              <div className="flex items-center space-x-3 min-w-0">
                <div className="w-8 h-8 rounded-full bg-amber-500/20 text-amber-400 border border-amber-500/40 flex items-center justify-center font-bold text-xs shrink-0">
                  🥇
                </div>
