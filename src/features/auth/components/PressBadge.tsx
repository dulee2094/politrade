...
export const PressBadge: React.FC<PressBadgeProps> = ({ mediaName = '언론사 기자', className = '' }) => {
  return (
    <span className={`inline-flex items-center space-x-1 bg-blue-950/80 text-blue-300 border border-blue-500/40 text-[10px] font-extrabold px-2 py-0.5 rounded-full shadow-sm ${className}`}>
